...
class CommunityAllCommentRVAdapter(val items:MutableList<CommunityAllArticleFragment.CommunityComment>):
    RecyclerView.Adapter<CommunityAllCommentRVAdapter.ViewHolder>() {

    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {

        fun bindItem(item: CommunityAllArticleFragment.CommunityComment){
